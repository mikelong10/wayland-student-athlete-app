...
const headerNavLinks: HeaderNavLink[] = [
  {
    ...
    variant: "ghost",
    mobileStyle:
      "text-2xl font-bold tracking-tight bg-transparent hover:bg-transparent underline-offset-8 hover:underline",
    desktopStyle:
  ...
  },
  {
    ...
    variant: "ghost",
    mobileStyle:
      "text-primary-foreground bg-primary hover:bg-primary/80 text-lg px-6 py-3 h-auto rounded-lg",
    desktopStyle:
