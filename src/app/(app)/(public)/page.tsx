...
export default function Home() {
  return (
    <main className="flex w-full flex-col items-center justify-center">
      <section
        id="landing-home"
        className="from-secondary to-background dark:from-background-less flex min-h-screen w-full flex-col justify-center gap-6 bg-gradient-to-tl to-70% px-6 md:px-10 lg:px-16 xl:px-24"
      >
